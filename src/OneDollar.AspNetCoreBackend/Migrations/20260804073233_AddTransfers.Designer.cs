...
namespace one_dollar.AspNetCoreBackend.Migrations
{
    ...
    [Migration("20260804073233_AddTransfers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneDollar.Api.Models.Tag", b =>
                {
            ...
            modelBuilder.Entity("OneDollar.Api.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("OneDollar.Api.Models.Account", "DestinationAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("TagTransaction", b =>
                {
                    b.HasOne("OneDollar.Api.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagsTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OneDollar.Api.Models.Transaction", null)
                        .WithMany()
